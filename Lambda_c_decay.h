...
// Wed May 29 12:35:41 2019 by ROOT version 6.16/00
// from TTree DecayTree/DecayTree
// found on file: myLcTuple_0.root
//////////////////////////////////////////////////////////

#ifndef Lambda_c_decay_h
#define Lambda_c_decay_h
...
class Lambda_c_decay : public TSelector {
public :
...
//   TTreeReaderValue<Int_t> L0Data_Sum_Et,Prev2 = {fReader, "L0Data_Sum_Et,Prev2"};
   ...
   Lambda_c_decay(TTree * /*tree*/ =0) { }
   virtual ~Lambda_c_decay() { }
   ...
   ClassDef(Lambda_c_decay,0);

};

#endif

#ifdef Lambda_c_decay_cxx
void Lambda_c_decay::Init(TTree *tree)
{
...
#endif // #ifdef Lambda_c_decay_cxx
