...
// Tue Jul 23 14:26:57 2019 by ROOT version 6.16/00
...
class BackgroundSubtraction : public TSelector {
public :
   ...
   BackgroundSubtraction(TTree * /*tree*/ =0) { }
   ...
   ClassDef(BackgroundSubtraction,0);

};

#endif

#ifdef BackgroundSubtraction_cxx
void BackgroundSubtraction::Init(TTree *tree)
{
...
Bool_t BackgroundSubtraction::Notify()
{
...
#endif // #ifdef BackgroundSubtraction_cxx
